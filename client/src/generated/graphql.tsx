...
export type LoginMutation = { __typename?: 'Mutation' } & {
	login: { __typename?: 'UserResponse' } & {
		...
		>;
		token?: Maybe<
			{ __typename?: 'Token' } & Pick<Token, 'access' | 'refresh'>
		>;
	};
};
...
export type SupporterMutation = { __typename?: 'Mutation' } & {
	handleSupporter: { __typename?: 'UserResponse' } & {
		errors?: Maybe<
			Array<
				{ __typename?: 'InputError' } & Pick<
					InputError,
		...
		user?: Maybe<
			{ __typename?: 'User' } & Pick<
				User,
				'name' | '_id' | 'creator' | 'email' | 'supporters'
			> & {
					supporting: Array<
						{ __typename?: 'User' } & Pick<User, '_id'>
					>;
...
export type FetchPostQuery = { __typename?: 'Query' } & {
	post?: Maybe<
		{ __typename?: 'Post' } & Pick<Post, 'title' | 'text'> & {
				poster?: Maybe<
					{ __typename?: 'User' } & Pick<
						User,
						'name' | '_id' | 'creator' | 'email' | 'supporters'
...
export type FetchUserQuery = { __typename?: 'Query' } & {
	fetchUser?: Maybe<
		{ __typename?: 'User' } & Pick<
			...
			'name' | '_id' | 'creator' | 'email' | 'supporters'
		> & {
				supporting: Array<{ __typename?: 'User' } & Pick<User, '_id'>>;
				posts: Array<
					{ __typename?: 'Post' } & Pick<
						Post,
						'title' | '_id' | 'createdAt' | 'text'
...
`;
export type SupporterMutationFn = Apollo.MutationFunction<
	SupporterMutation,
	SupporterMutationVariables
>;
 ...
 * });
 */
export function useSupporterMutation(
	baseOptions?: Apollo.MutationHookOptions<
		SupporterMutation,
		SupporterMutationVariables
	>
) {
	return Apollo.useMutation<SupporterMutation, SupporterMutationVariables>(
		SupporterDocument,
		baseOptions
	);
}
export type SupporterMutationHookResult = ReturnType<
	typeof useSupporterMutation
>;
export type SupporterMutationResult = Apollo.MutationResult<SupporterMutation>;
export type SupporterMutationOptions = Apollo.BaseMutationOptions<
	SupporterMutation,
	SupporterMutationVariables
>;
